...
@ApiModel(value = "package - 交货管理 - 地址信息模板表", description = "PackageManagementConfig对象")
public class PackageManagementConfig extends BaseEntity {
