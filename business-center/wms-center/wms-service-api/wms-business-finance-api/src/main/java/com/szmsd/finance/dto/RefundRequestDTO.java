...
public class RefundRequestDTO {
    ...
    @ExcelProperty(value = "处理性质", index = 1)
    ...
    @ExcelProperty(value = "责任地区", index = 2)
    ...
    @ExcelProperty(value = "业务明细", index = 12)
    ...
    @ExcelProperty(value = "标准赔付", index = 4)
    ...
    @ExcelProperty(value = "额外赔付", index = 5)
    ...
    @ExcelProperty(value = "供应商是否完成赔付", index = 6)
    ...
    @ExcelProperty(value = "赔付金额", index = 7)
    ...
    @ExcelProperty(value = "赔付币别", index = 8)
    ...
    @ExcelProperty(value = "处理号", index = 15)
    ...
    @ExcelProperty(value = "属性", index = 18)
    ...
    @ExcelProperty(value = "供应商确认不赔付", index = 9)
    ...
    @ExcelProperty(value = "供应商确认赔付未到账", index = 10)
    ...
    @ExcelProperty(value = "费用类别", index = 14)
    @Excel(name = "费用类别")
