...
public class AccountSerialBillRequest extends QueryDto {
    ...
    @Size(max = 30, message = "单号最大支持30字符")
    ...
    @Size(max = 200, message = "业务类别最大支持200字符")
    ...
    @ApiModelProperty(value = "计算时间开始 yyyy-MM-dd HH:mm:ss", example = "yyyy-MM-dd HH:mm:ss")
    private String createTimeStart;

    @ApiModelProperty(value = "计算时间结束 yyyy-MM-dd HH:mm:ss", example = "yyyy-MM-dd HH:mm:ss")
