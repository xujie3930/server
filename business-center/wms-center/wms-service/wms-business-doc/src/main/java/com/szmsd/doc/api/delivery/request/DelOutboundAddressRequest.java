...
public class DelOutboundAddressRequest {
    ...
    @Size(max = 50, message = "收件人长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class, DelOutboundGroup.Collection.class})
    ...
    @Size(max = 500, message = "街道1长度不能超过500个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class, DelOutboundGroup.Collection.class})
    ...
    @Size(max = 50, message = "国家代码长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class, DelOutboundGroup.Collection.class})
    ...
    @Size(max = 50, message = "国家名称长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class, DelOutboundGroup.Collection.class})
    ...
    @Size(max = 50, message = "邮编长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class, DelOutboundGroup.Collection.class})
