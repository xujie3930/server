...
public class DelOutboundAddressRequest {
    ...
    @NotBlank(message = "收件人不能为空", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @Size(max = 50, message = "收件人长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    ...
    @NotBlank(message = "街道1不能为空", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @Size(max = 500, message = "街道1长度不能超过500个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    ...
    @NotBlank(message = "国家代码不能为空", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @Size(max = 50, message = "国家代码长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @ApiModelProperty(value = "国家代码", required = true, dataType = "String", example = "xxx")
    private String countryCode;

    @NotBlank(message = "国家名称不能为空", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @Size(max = 50, message = "国家名称长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @ApiModelProperty(value = "国家名称", required = true, dataType = "String", example = "xxx")
    private String country;

    @NotBlank(message = "邮编不能为空", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
    @Size(max = 50, message = "邮编长度不能超过50个字符", groups = {DelOutboundGroup.PackageTransfer.class, DelOutboundGroup.Normal.class})
