    ...
    public boolean updateBalance(CustPayDTO dto){
        ...
        try{
            if(lock.tryLock(time,unit)){
                //1.先扣款
                BigDecimal oldBalance1=getCurrentBalance(dto.getCusId(),dto.getCurrencyId());
                ...
                setCurrentBalance(dto.getCusId(),dto.getCurrencyId(),result1);
                dto.setPayMethod(BillEnum.PayMethod.EXCHANGE_PAYMENT);
                recordOpLog(dto,result1);
                //2.再充值
                BigDecimal oldBalance2=getCurrentBalance(dto.getCusId(),dto.getCurrencyId2());
                ...
                setCurrentBalance(dto.getCusId(),dto.getCurrencyId(),result2);
