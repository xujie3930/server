    ...
    public boolean updateBalance(CustPayDTO dto){
        ...
        try{
            if(lock.tryLock(time,unit)){
                //1.先扣款
                BigDecimal oldBalance1=getCurrentBalance(dto.getCusId(),dto.getCurrencyCode());
                ...
                setCurrentBalance(dto.getCusId(),dto.getCurrencyCode(),result1);
                dto.setPayMethod(BillEnum.PayMethod.EXCHANGE_PAYMENT);
                recordOpLog(dto,result1);
                //2.再充值
                BigDecimal oldBalance2=getCurrentBalance(dto.getCusId(),dto.getCurrencyCode2());
                ...
                setCurrentBalance(dto.getCusId(),dto.getCurrencyCode(),result2);
